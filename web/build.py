...
out = (template
       ...
       .replace("/*__MASSECUITE_JS__*/", read("src/massecuite.js"))
       .replace("/*__PAN_JS__*/", read("src/pan.js"))
       .replace("/*__CRYSTALLIZER_REHEATER_JS__*/", read("src/crystallizer_reheater.js"))
       .replace("/*__CENTRIFUGAL_JS__*/", read("src/centrifugal.js"))
       .replace("/*__FOUR_BOILING_DOUBLE_MAGMA_JS__*/", read("src/four_boiling_double_magma.js"))
